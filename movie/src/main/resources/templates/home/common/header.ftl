<div class="header">
    ...
    <ylrc_auth />
    <div class="top-nav" id="show-copyright" style="display:none;">
        <div class="container fn-clear" align="center">
              <p style="color:red;font-size:16px;">
              	本系统由<a href="https://www.baidu.com/product/details.html?pid=413">【XXXX】</a>发布，请认准官网获取，官网获取的正版源码提供免费更新升级！
              	<a href="javascript:alert('请登录后台首页填写订单号进行验证，验证通过后刷新此页面，版权信息会自动消失！')" id="order-auth-btn">点此去版权</a>
              	<a href="https://www.baidu.com/">点此进入官网</a>
              </p>
        </div>
    </div>
